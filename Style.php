 ...
 *
 * Основное назначение класса загрузка и хранение оформлений для приложения и его компонентов
 * При инициализации класса передается обязательный аргумент, название дочернего каталога приложения.
 * В котором будут хранится темы оформления для приложения
 *
 ...
 *
 *
 * Задать стиль для элемента Qt достаточно просто
 *
 ...
 *
 * Добавлен метод about(), который возвращает информацию о теме оформления в виде массива.
